...
for (i in ascu){
  ...
  asmallchange$`REP-DEM`[asmallchange$VoterID == i] = sum(asmallchange[, (asmallchange$Party == c('REP', 'DEM') & asmallchange$VoterID == i)])%/%2
  #  
...
for (i in wscu){
  ...
  wsmallchange$`REP-DEM`[wsmallchange$VoterID == i] = sum(wsmallchange[, (wsmallchange$Party == c('REP', 'DEM') & wsmallchange$VoterID == i)])%/%2
  #  
...
for (i in hscu){
  ...
  hsmallchange$`REP-DEM`[hsmallchange$VoterID == i] = sum(hsmallchange[, (hsmallchange$Party == c('REP', 'DEM') & hsmallchange$VoterID == i)])%/%2
  #  
...
for (i in bscu){
  ...
  bsmallchange$`REP-DEM`[bsmallchange$VoterID == i] = sum(bsmallchange[, (bsmallchange$Party == c('REP', 'DEM') & bsmallchange$VoterID == i)])%/%2
  #  
...
for (i in nscu){
  nsmallchange$`REP-UAF`[nsmallchange$VoterID == i] = sum(nsmallchange[, (nsmallchange$Party == c('REP', 'UAF') & nsmallchange$VoterID == i)])%/%2
  nsmallchange$`REP-DEM`[nsmallchange$VoterID == i] = sum(nsmallchange[, (nsmallchange$Party == c('REP', 'DEM') & nsmallchange$VoterID == i)])%/%2
  #  
  nsmallchange$`UAF-REP`[nsmallchange$VoterID == i] = sum(nsmallchange[, (nsmallchange$Party == c('UAF', 'REP') & nsmallchange$VoterID == i)])%/%2
  nsmallchange$`UAF-DEM`[nsmallchange$VoterID == i] = sum(nsmallchange[, (nsmallchange$Party == c('UAF', 'DEM') & nsmallchange$VoterID == i)])%/%2
  #  
  nsmallchange$`DEM-REP`[nsmallchange$VoterID == i] = sum(nsmallchange[, (nsmallchange$Party == c('DEM', 'REP') & nsmallchange$VoterID == i)])%/%2
  nsmallchange$`DEM-UAF`[nsmallchange$VoterID == i] = sum(nsmallchange[, (nsmallchange$Party == c('DEM', 'UAF') & nsmallchange$VoterID == i)])%/%2
}
